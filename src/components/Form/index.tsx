...
import { formItemConfig, formProps, setFormConfig } from './util'
				...
				<div>
					...
					<div>
						<Form ref={formRef} {...setFormConfig(props)}>
							<RFormItem formItemStyle={props.formItemStyle} model={props.model} rows={props.rows} v-slots={slots} {...formItemConfig(props)} />
						</Form>
					</div>
