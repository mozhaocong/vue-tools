...
import Reconfigure from '@/components/Configure'
import { clone } from 'ramda'
import { deepClone, isTrue } from '@ht/html-tool'
import { columnsSetArrayDiffArray, setCustomRow } from '@/components/utils'
import { Button, Divider } from 'ant-design-vue'
import { DoubleRightOutlined } from '@ant-design/icons-vue'
import { useRequest } from './hooks/UseRequest'
import { usePagination } from './hooks/UsePagination'
import { useSearch } from './hooks/UseSearch'
import { commonly } from './hooks/PublicMethod'
import './index.less'
const Props = {
	model: {
		...
		return () => {
			return (
				<div style='position: relative; margin: 0 0 16px;border-radius: 4px;background: #fff;'>
					...
					<Reconfigure v-model={visible.value} onSubmit={submit} title='查询条件调整自定义' columns={clone(customRow.value) as any} />
				</div>
			)
		}
	},
...
Rsearch.useRequest = useRequest
Rsearch.usePagination = usePagination
Rsearch.useSearch = useSearch
Rsearch.commonly = commonly
