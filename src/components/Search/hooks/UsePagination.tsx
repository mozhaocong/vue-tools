...
import { ParamsPaginationKey } from './UseRequest'
 ...
 * @returns
 */
export function usePagination(search: (type?: PageType) => void, paramsPaginationKey: ParamsPaginationKey, defaultConfig?: DefaultConfig) {
	const total = ref(0)
	...
	function renderPagination(props?: Pagination) {
		const prop = pick(['showTotal', 'pageSizeOptions', 'showQuickJumper', 'showSizeChanger'], props ?? defaultConfig ?? {})
		return (
